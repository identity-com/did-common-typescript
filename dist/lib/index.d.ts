...
export { Did, DidUrl, DidUrlFragment, DidDocument, IDidDocument, IDidDocumentPublicKey, IDidDocumentServiceDescriptor, IDidResolver, IDidResolveResult, HttpResolver, HttpResolverOptions };
export declare const unitTestExports: {
    TestResolver: typeof TestResolver;
};
